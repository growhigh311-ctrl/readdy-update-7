export const CONFIG = {
  ...
  domainName: "reddybluebook.in",
  whatsappUrl: "https://wa.me/917589045547",
  whatsappSupportUrl: "https://wa.me/917589045547",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Visit reddybluebook.in, click the WhatsApp button, and contact our official agent. Share your preferred username and password. Your ID is created and delivered in under 60 seconds."
    },
    {
      question: "Is Reddy Anna safe and legitimate?",
      answer: "Yes. Reddy Anna has operated safely since 2010, serving millions of verified users across India. All transactions are encrypted, all payments are processed through secure Indian banking channels, and all payouts are guaranteed. reddybluebook.in is the only official Reddy Anna domain — always verify you are on the right site."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes. reddybluebook.in offers a comprehensive live casino section featuring Teen Patti, Andar Bahar, Roulette, Blackjack, Baccarat, Poker, Dragon Tiger, and hundreds of slots. All games run 24/7 with live dealers and certified fair-play mechanisms."
    },
    {
      question: "How can I contact Reddy Anna support?",
      answer: "Our support team is available 24/7 via WhatsApp and Telegram. Visit reddybluebook.in and click the WhatsApp icon for instant connection to our support team. Average response time is under 2 minutes, even during live matches."
    },
    {
